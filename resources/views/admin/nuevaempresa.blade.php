                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12 pt-5">
                            <form method="post"  action="{{ route('admin.nuevaempresa') }}" >
                                @csrf
                                <div class="row">
                                    <div class="col-md-4">
                                        <label for="solicitado_por" class="form-label">Codigo Empresa</label>
                                        <input type="number" class="form-control @error('cod_empresa') is-invalid @enderror" id="cod_empresa" name="cod_empresa" value="{{old('cod_empresa')}}">
                                        @error('cod_empresa')
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control @error('cod_empresa') is-invalid @enderror" id="nombre_empresa" name="nombre_empresa" value="{{ old('nombre')}}">
